...
-- Inner Join entre Produtos e Usuarios

select * from tb_produtos inner join tb_usuarios on tb_produtos.usuario_id = tb_usuarios.id;


-- Inner Join entre produtos, Categorias e Usuarios

-- select * from tb_produtos 
-- inner join tb_categoria on tb_produtos.categoria_id = categorias.id 
-- inner join tb_usuarios on tb_produtos.usuarios_id = tb_usuarios.id;
select * from tb_produtos 
